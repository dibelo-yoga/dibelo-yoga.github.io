! function (e, t) {
    ...
    function r(e, t, n) {
        ...
        var o = r[t].indexOf(n);
        return -1 !== o && r[t].splice(o, 1), E.set(e.element, r), r[t] && 0 === r[t].length
    }
            ...
            a.open("GET", o, !0), a.onload = function () {
                if (404 !== a.status)
                    if (403 !== a.status) try {
                        ...
                        r(e)
                    } else r(new Error("â€œ" + e + "â€ is not embeddable."));
                    else r(new Error("â€œ" + e + "â€ was not found."))
            }, a.onerror = function () {
    ...
    var k = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
        b = (e(function (e, t) {
            ...
            ! function (t, n, r) {
                ...
                function o(e, t, r) {
                    var o, i;
                    try {
                        !1 === t ? r.reject(e.msg) : (o = !0 === t ? e.msg : t.call(void 0, e.msg)) === r.promise ? r.reject(TypeError("Promise-chain cycle")) : (i = n(o)) ? i.call(o, r.resolve, r.reject) : r.resolve(o)
                    } catch (e) {
                        r.reject(e)
                    }
                }
        ...
        M = function () {
            function e(t) {
                ...
                if (m(this, e), window.jQuery && t instanceof jQuery && (t.length > 1 && window.console && console.warn && console.warn("A jQuery object with multiple elements was passed, using the first element."), t = t[0]), "string" == typeof t && (t = document.getElementById(t)), !u(t)) throw new TypeError("You must pass either a valid element or a valid id.");
                ...
                var a = new b(function (e, o) {
                    ...
                    if (window.addEventListener ? window.addEventListener("message", a, !1) : window.attachEvent && window.attachEvent("onmessage", a), "IFRAME" !== n.element.nodeName) {
                        var u = l(t, r);
                        h(f(u), u).then(function (e) {
                            var r = d(e, t);
                            return n.element = r, i(t, r), j.set(n.element, n), e
                        }).catch(function (e) {
                            return o(e)
                        })
                    }
                });
                return x.set(this, a), j.set(this.element, this), "IFRAME" === this.element.nodeName && p(this, "ping"), this
            }
            return _(e, [{
                key: "callMethod",
                value: function (e) {
